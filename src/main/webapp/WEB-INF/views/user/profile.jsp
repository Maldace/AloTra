	        ...
	        <div class="col-md-7 offset-md-1">
	            ...
	            <form action="user/updateUser" method="post">
	                ...
	                <div class="mb-3">
	                    ...
	                    <input type="text" name="password" class="form-control bg-light" value="${user.passWord}">
	                </div>
	                
	                <div class="mb-3">
	                    <label class="form-label">Tên đầy đủ</label>
	                    <input type="text" name="fullname" class="form-control bg-light" value="${user.fullName}">
	                </div>
	                ...
	                <div class="mb-3">
	                    ...
	                    <div class="input-group">
	                        ...
	                        <input type="text" name="avatar" class="form-control" placeholder="${user.avatar}">
	                    </div>
	                </div>
