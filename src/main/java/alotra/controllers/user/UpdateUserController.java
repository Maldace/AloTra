...
public class UpdateUserController extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.setAttribute("successMessage", "Lưu thay đổi thành công"); // gửi thông báo sang JSP
        req.getRequestDispatcher("/WEB-INF/views/user/profile.jsp").forward(req, resp); // quay lại trang
